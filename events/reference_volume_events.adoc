...
情報
 ...
 a| 
ボリュームのランサムウェア対策監視が一時停止（ラーニングモード）
...
警告
 ...
 a| 
ボリュームのランサムウェア対策監視が一時停止（アクティブモード）
